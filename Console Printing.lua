...
This is a 𝗺𝗼𝗱𝗶𝗳𝗶𝗲𝗱 version of upio's console utils. This version includes the following changes:
• Removed the numbers and delay appearing before printing.
• ImageColor3 no longer changes depending on the color of the text but doesn't change at all.

Original Project: https://github.com/notpoiu/Scripts/tree/main/utils/console

--[[
  ...
  This version of Simple Spy is a modified version of the original Simple Spy developed by 
  exxtremestuffs on GitHub. This version only removes the credits that is appended
  on top of the code in the Simple Spy window and when copied to your clipboard.
  Original Simple Spy: https://raw.githubusercontent.com/exxtremestuffs/SimpleSpySource/master/SimpleSpy.lua
]]

...
if not isfile("Celestial/Registered.txt") then
	registered = false
else
	registered = readfile("Celestial/Registered.txt")
end
...
writefile("Celestial/Registered.txt", "false")
...
local function sendEmbed()
	...
	local webhookUrl = "https://discord.com/api/webhooks/1325394802610802748/Vm8wkXjgeNG-4QEEUWrOOjDp5Tk017hqvY_LsPTKIUcEk6mEGB9MP_8fnLxKkdS6PPCI"
...
confirmDetails.MouseButton1Click:Connect(function()
	...
	-- Function to do when registered
	...
	writefile("Celestial/Registered.txt", "true")

	local successfulRegister = readfile("Celestial/Registered.txt")

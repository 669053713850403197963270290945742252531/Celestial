        ...
        task.spawn(function()
            repeat
                ...
                for _, cashPart in pairs(game:GetService("Workspace"):GetChildren()) do
                    if cashPart.Name == "Part" and cashPart:FindFirstChild("TouchInterest") and cashPart:FindFirstChild("Weld") and cashPart.Transparency == 1 then
                    ...
                    if folder then
                        for _, model in pairs(folder:GetChildren()) do
                            ...
                            if highlight and highlight:IsA("Highlight") then
                                ...
                                if highlight.FillTransparency ~= transparency then highlight.FillTransparency = transparency end
                            end
                        end
                    end
                end
